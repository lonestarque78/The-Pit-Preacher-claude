...
export default function FixPanel({ onClose }: { onClose?: () => void }) {
  ...
  return (
    <div>
            ...
            {loading ? (
              ...
              <>
                ...
                <div style={{
                  ...
                  <Link
                    href={activeCook ? `/cook/${activeCook.id}?tab=live` : "/dashboard"}
                    style={{
                      background: "#C9973A",
                      color: "var(--color-bg)",
                      fontFamily: "var(--font-ui)",
      ...
      <div style={{
        ...
        <button onClick={() => onClose?.()} className="fix-nav-btn" style={{ background: "none", cursor: "pointer" }}>← Close</button>
