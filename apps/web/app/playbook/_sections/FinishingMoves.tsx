...
export default function FinishingMoves() {
  return (
      <PlaybookArticle
        module="Module 06 — Free"
      ...
      >
        ...
        <RelatedLinks
          links={[
            { label: "Meat Science", href: "/playbook?tab=meat-science" },
            { label: "Troubleshooting", href: "/playbook?tab=troubleshooting" },
            { label: "Timeline Philosophy", href: "/playbook?tab=timeline-philosophy" },
          ]}
        />
