...
export default async function PitTypes() {
  ...
  return (
      ...
      >
        ...
        <RelatedLinks
          links={[
            { label: "Fire Behavior", href: "/playbook?tab=fire-behavior" },
            { label: "The Holy Trinity", href: "/playbook?tab=holy-trinity" },
