...
export default function TimelinePage({ params, onNavigate }: { params: Promise<{ id: string }>; onNavigate?: (tab: string) => void }) {
            ...
            return (
              ...
              >
                ...
                <div style={{ marginBottom: "var(--space-3)", textAlign: "right" }}>
                  <Link href="/dashboard?fix=1" style={{ fontFamily: "var(--font-ui)", fontSize: "0.78rem", color: "#8B6914", textDecoration: "none", opacity: 0.9 }}>
                    Pit Rescue →
                  </Link>
                </div>
