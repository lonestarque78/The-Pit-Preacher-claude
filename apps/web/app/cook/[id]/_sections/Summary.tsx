...
export default function SummaryPage({ params, onNavigate, onShare }: { params: Promise<{ id: string }>; onNavigate?: (tab: string) => void; onShare?: () => void }) {
        ...
        <div>
          ...
          {!hasTrackerData && statusIsCompleted && (
            <div style={{
              ...
              <button onClick={() => onNavigate?.("tracker")} style={{
                background: "#C9973A",
                color: "var(--color-bg)",
                fontFamily: "var(--font-ui)",
                fontSize: "0.8rem",
          ...
          {!outcome && !trackerNotes && statusIsCompleted && (
            <div style={{ ...cardStyle, marginTop: "var(--space-4)", border: "1px solid rgba(201,151,58,0.25)" }}>
              ...
              <button onClick={() => onNavigate?.("tracker")} style={{
                color: "#C9973A", fontFamily: "var(--font-ui)", fontSize: "0.8rem", background: "none", border: "none", cursor: "pointer", padding: 0,
              }}>
                Track This Cook →
              </button>
            </div>
