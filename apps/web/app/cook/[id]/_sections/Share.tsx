...
export default function SharePage({ params, onClose }: { params: Promise<{ id: string }>; onClose?: () => void }) {
  ...
  return (
    <div className="share-page">
      ...
      <div className="share-header">
        <button onClick={() => onClose?.()} className="share-back-link" style={{ background: "none", border: "none", cursor: "pointer" }}>
          ← Summary
        </button>
