...
export default function CookDashboardPage({ params, onNavigate }: { params: Promise<{ id: string }>; onNavigate?: (tab: string) => void }) {
                    ...
                    <div>
                      ...
                      <p style={{
                        ...
                        <button
                          ...
                          style={{ color: "#C9973A", fontFamily: "var(--font-ui)", fontSize: "0.8rem", textDecoration: "none", background: "none", border: "none", cursor: "pointer", padding: 0 }}
                        >
                          step into Live Mode →
                        </button>
                      </p>
